...
def analyze_reviews(user_id):
    ...
    analyzed_reviews = review_service.analyze_reviews(reviews,
                                                      feature_model,
                                                      sentiment_model,
                                                      sibling_threshold)
...
# TODO endpoint to call dendogram generator to get the tree names
DATA_DIR = r"C:\Users\Max\NLP4RE\Dendogram-Generator\data\Stage 3 - Topic Modelling\output"
